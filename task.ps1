...
$lbFrontEndIP = New-AzLoadBalancerFrontendIpConfig @lbip

$lbBackEndPool = New-AzLoadBalancerBackendAddressPoolConfig -Name "$lbName.BackEndPool"
...
$lbRule = New-AzLoadBalancerRuleConfig @rule -EnableTcpReset
